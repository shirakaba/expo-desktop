...
When you are ready to release, on an up-to-date `main` branch run `bun run release:version`, review the diff, commit, and push. CI publishes to npm when those commits touch the packages’ `package.json` and `CHANGELOG.md`.
