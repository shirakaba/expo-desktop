...
std::string to_string(const ExpoDesktopStubsCodegen::DataMarshallingExamplesSpec_Point &pt) {
  return "(" + std::to_string(pt.X) + "," + std::to_string(pt.Y) + ")";
}

std::string to_string(const ExpoDesktopStubsCodegen::DataMarshallingExamplesSpec_Line &line) {
...
struct DataMarshallingExamples {
  using ModuleSpec = ExpoDesktopStubsCodegen::DataMarshallingExamplesSpec;

  using Line = ExpoDesktopStubsCodegen::DataMarshallingExamplesSpec_Line;
  using Point = ExpoDesktopStubsCodegen::DataMarshallingExamplesSpec_Point;
