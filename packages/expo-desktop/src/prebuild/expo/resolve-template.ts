...
import { createGlobFilter } from "../../common/expo/create-file-transform.ts";
import { AbortCommandError } from "../../common/expo/error.ts";
...
} from "../../common/expo/npm.ts";
import { isUrlOk } from "../../common/expo/url.ts";
import { resolveLocalTemplateAsync } from "./resolve-local-template.ts";

const debug = Debug("expo-desktop:prebuild:resolveTemplate") as typeof console.log;
...
/**
 * Given an `sdkVersion` like `44.0.0` return a fully qualified NPM package
 * name like: `expo-desktop-template-bare-minimum@sdk-44`
 */
