// https://github.com/microsoft/react-native-test-app/blob/trunk/packages/app/scripts/config-plugins/types.ts
...
export type IosModFileProviders = ReturnType<typeof BaseMods.getIosModFileProviders> &
