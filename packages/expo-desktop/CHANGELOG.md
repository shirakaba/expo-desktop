...
- Launch macOS apps in the foreground by default with `expo-desktop run macos`. Use `--background` to launch in the background.
...
- Handle output of `npm pack` on Windows
